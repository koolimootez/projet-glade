                                        ...
                                        gpointer         user_data)
{
	...
	{
	strcpy(genre_value,"homme");
	}else
	{
	strcpy(genre_value,"femme");
	}
					...
					gpointer         user_data)
{
	...
	char bureau_de_vote_value [20];
	bureau_de_vote_entry = lookup_widget(objet_graphique, "bureau_de_vote_entry") ;
	strcpy(bureau_de_vote_value,gtk_entry_get_text(GTK_ENTRY(bureau_de_vote_entry)));
